...
- [tarampampam/error-pages](https://github.com/tarampampam/error-pages) ([v2.10.1](https://github.com/tarampampam/error-pages/releases/tag/v2.10.1), 3 days ago) - 🚧 Pretty server&#39;s error pages in the docker image &amp; git repository
