...
- [44 fix routing rules](https://github.com/freifunkMUC/wg-access-server/pull/86) on [freifunkMUC/wg-access-server](https://github.com/freifunkMUC/wg-access-server) (3 days ago)
- [Added: Dependabot &amp; Dockerfile image tags](https://github.com/vector-im/hydrogen-web/pull/652) on [vector-im/hydrogen-web](https://github.com/vector-im/hydrogen-web) (3 days ago)
- [Set node to a more fine-grained version](https://github.com/freifunkMUC/wg-access-server/pull/85) on [freifunkMUC/wg-access-server](https://github.com/freifunkMUC/wg-access-server) (3 days ago)
...
- [offdroid/swmn](https://github.com/offdroid/swmn) - Certificate management server with api and web UI (6 days ago)
