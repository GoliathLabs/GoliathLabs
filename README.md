...
- [freifunkMUC/site-ffm](https://github.com/freifunkMUC/site-ffm) ([v2023.11.5](https://github.com/freifunkMUC/site-ffm/releases/tag/v2023.11.5), 2 days ago) - Freifunk München specific Gluon configuration
...
- [[Snyk] Upgrade react-router-dom from 6.21.0 to 6.21.1](https://github.com/freifunkMUC/wg-access-server/pull/553) on [freifunkMUC/wg-access-server](https://github.com/freifunkMUC/wg-access-server) (2 days ago)
- [[Snyk] Upgrade @mui/material from 5.15.0 to 5.15.1](https://github.com/freifunkMUC/wg-access-server/pull/552) on [freifunkMUC/wg-access-server](https://github.com/freifunkMUC/wg-access-server) (3 days ago)
