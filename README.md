...
- [openwrt/openwrt](https://github.com/openwrt/openwrt) ([v25.12.5](https://github.com/openwrt/openwrt/releases/tag/v25.12.5), today) - This repository is a mirror of https://git.openwrt.org/openwrt/openwrt.git It is for reference only and is not active for check-ins.  We will continue to accept Pull Requests here. They will be merged via staging trees then into openwrt.git.
- [Koenkk/zigbee-herdsman-converters](https://github.com/Koenkk/zigbee-herdsman-converters) ([v26.76.0](https://github.com/Koenkk/zigbee-herdsman-converters/releases/tag/v26.76.0), 1 day ago) - Collection of device converters to be used with zigbee-herdsman
...
- [roaldnefs/salt-lint-action](https://github.com/roaldnefs/salt-lint-action) ([v0.0.3](https://github.com/roaldnefs/salt-lint-action/releases/tag/v0.0.3), 10 months ago) - GitHub Action for running salt-lint as part of your workflows!

#### 🔨 My recent Pull Requests

- [fix: high CPU usage with eventlet](https://github.com/stlehmann/Flask-MQTT/pull/218) on [stlehmann/Flask-MQTT](https://github.com/stlehmann/Flask-MQTT) (2 days ago)
