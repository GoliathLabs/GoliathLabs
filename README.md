...
- [cinnyapp/cinny](https://github.com/cinnyapp/cinny) ([v2.1.0](https://github.com/cinnyapp/cinny/releases/tag/v2.1.0), today) - Yet another matrix client
- [tarampampam/error-pages](https://github.com/tarampampam/error-pages) ([v2.17.0](https://github.com/tarampampam/error-pages/releases/tag/v2.17.0), 1 week ago) - 🚧 Pretty server&#39;s error pages in the docker image &amp; git repository
