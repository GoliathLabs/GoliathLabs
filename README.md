...
- [freifunkMUC/site-ffm](https://github.com/freifunkMUC/site-ffm) ([v2022.5.3](https://github.com/freifunkMUC/site-ffm/releases/tag/v2022.5.3), 3 days ago) - Freifunk München specific Gluon configuration
...
- [[Snyk] Upgrade react-router-dom from 6.16.0 to 6.17.0](https://github.com/freifunkMUC/wg-access-server/pull/503) on [freifunkMUC/wg-access-server](https://github.com/freifunkMUC/wg-access-server) (5 days ago)
- [[Snyk] Upgrade @mui/material from 5.14.8 to 5.14.13](https://github.com/freifunkMUC/wg-access-server/pull/502) on [freifunkMUC/wg-access-server](https://github.com/freifunkMUC/wg-access-server) (6 days ago)
