...
- [tarampampam/error-pages](https://github.com/tarampampam/error-pages) ([v2.4.0](https://github.com/tarampampam/error-pages/releases/tag/v2.4.0), 2 days ago) - :construction: Server error pages in the docker image
- [ajbura/cinny](https://github.com/ajbura/cinny) ([v1.7.0](https://github.com/ajbura/cinny/releases/tag/v1.7.0), 4 days ago) - Yet another matrix client
...
- [offdroid/swmn](https://github.com/offdroid/swmn) - Certificate management server with api and web UI (3 days ago)
- [Monogramm/autodiscover-email-settings](https://github.com/Monogramm/autodiscover-email-settings) - :whale: :wrench: Provides Autodiscover capabilities for IMAP/POP/SMTP/LDAP services on Microsoft Outlook/Apple Mail and Autoconfig capabilities for Thunderbird (4 days ago)
- [ajbura/cinny](https://github.com/ajbura/cinny) - Yet another matrix client (4 days ago)
- [acecilia/OpenWRTInvasion](https://github.com/acecilia/OpenWRTInvasion) - Root shell exploit for several Xiaomi routers: 4A Gigabit, 4A 100M, 4, 4C, 3Gv2, 4Q, miWifi 3C... (4 days ago)
- [byro/byro](https://github.com/byro/byro) - Plugin-based, unopinionated membership administration software (5 days ago)
