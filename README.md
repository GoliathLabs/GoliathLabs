...
- [tarampampam/error-pages](https://github.com/tarampampam/error-pages) ([v2.10.1](https://github.com/tarampampam/error-pages/releases/tag/v2.10.1), 1 day ago) - 🚧 Pretty server&#39;s error pages in the docker image
- [42wim/matterbridge](https://github.com/42wim/matterbridge) ([v1.24.1](https://github.com/42wim/matterbridge/releases/tag/v1.24.1), 6 days ago) - bridge between mattermost, IRC, gitter, xmpp, slack, discord, telegram, rocketchat, twitch, ssh-chat, zulip, whatsapp, keybase, matrix, microsoft teams, nextcloud, mumble, vk and more with REST API (mattermost not required!)
