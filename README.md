...
- [freifunkMUC/site-ffm](https://github.com/freifunkMUC/site-ffm) ([v2023.12.2-next](https://github.com/freifunkMUC/site-ffm/releases/tag/v2023.12.2-next), 4 days ago) - Freifunk München specific Gluon configuration
- [freifunk-gluon/gluon](https://github.com/freifunk-gluon/gluon) ([v2023.2](https://github.com/freifunk-gluon/gluon/releases/tag/v2023.2), 6 days ago) - a modular framework for creating OpenWrt-based firmwares for wireless mesh nodes
...
- [[Snyk] Upgrade @mui/material from 5.15.0 to 5.15.1](https://github.com/freifunkMUC/wg-access-server/pull/552) on [freifunkMUC/wg-access-server](https://github.com/freifunkMUC/wg-access-server) (1 day ago)
