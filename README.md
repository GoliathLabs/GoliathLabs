...
- [tarampampam/error-pages](https://github.com/tarampampam/error-pages) ([v2.9.0](https://github.com/tarampampam/error-pages/releases/tag/v2.9.0), 1 day ago) - 🚧 Pretty server&#39;s error pages in the docker image
- [42wim/matterbridge](https://github.com/42wim/matterbridge) ([v1.24.1](https://github.com/42wim/matterbridge/releases/tag/v1.24.1), 4 days ago) - bridge between mattermost, IRC, gitter, xmpp, slack, discord, telegram, rocketchat, twitch, ssh-chat, zulip, whatsapp, keybase, matrix, microsoft teams, nextcloud, mumble, vk and more with REST API (mattermost not required!)
- [ajbura/cinny](https://github.com/ajbura/cinny) ([v1.8.2](https://github.com/ajbura/cinny/releases/tag/v1.8.2), 6 days ago) - Yet another matrix client
...
- [Make salt-linter happy again](https://github.com/freifunkMUC/ffmuc-salt-public/pull/87) on [freifunkMUC/ffmuc-salt-public](https://github.com/freifunkMUC/ffmuc-salt-public) (3 days ago)
...
- [Added: docker-compose examples](https://github.com/nttgin/BGPalerter/pull/774) on [nttgin/BGPalerter](https://github.com/nttgin/BGPalerter) (4 weeks ago)
