...
- [Koenkk/zigbee-herdsman-converters](https://github.com/Koenkk/zigbee-herdsman-converters) ([v25.65.0](https://github.com/Koenkk/zigbee-herdsman-converters/releases/tag/v25.65.0), 2 days ago) - Collection of device converters to be used with zigbee-herdsman
...
- [traggo/server](https://github.com/traggo/server) - self-hosted tag-based time tracking (3 months ago)
